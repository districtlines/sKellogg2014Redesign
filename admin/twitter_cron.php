<?php
	 ...
	 set_time_limit(0);
	 include_once("includes/functions/easydb_functions.php");
	 ...
	 $json = curl("http://api.twitter.com/1/statuses/user_timeline.json?screen_name=SK6ers&since_id=".$last_run."&count=5");
	 //$json = curl("http://api.twitter.com/1/statuses/user_timeline.json?screen_name=SK6ers&count=5");
	 //print_r($json);
